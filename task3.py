...
def list_function(num_local, list_vars=[]):
    list_vars.append(num_local * num_global)

    return len(list_vars), list_vars


def print_vars(*args, **kwargs):
    print("The non-keyworded vars: ", args, '\n',
          "The keyworded vars: ", kwargs, sep='')
...
def fibonacci(num):
    # Ternary operator
    return 1 if num in (1, 2) else fibonacci(num - 1) + fibonacci(num - 2)
...
if __name__ == "__main__":
    ...
    for i in range(1, 6):
        list_len, list_ = list_function(i * i)
    print("List length is ",list_len, '\n',
          "List: ", list_, sep='')

    print_vars(21, 1.94, "Kolodiazhnyi", name="Igor")

    print("572 divisible by 43 -", is_divisible_by(572, 43))
    print("648 divisible by 8 -", is_divisible_by(648, 8))

    print("Fibonacci(12) is", fibonacci(12))
